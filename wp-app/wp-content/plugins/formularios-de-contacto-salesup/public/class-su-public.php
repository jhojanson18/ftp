    ...
    public function sudatos_shortcode_id($atts, $content = ''){
        ...
        if($id != ""){
            ...
            if( $resultado[0]->id_formulario != '' ){
                ...
                $sql_campos = $this->db->prepare("SELECT * FROM " . SAUP190122_TABLE_CAMPOS . " WHERE id_formulario = %d", intval($resultado[0]->id_formulario) );
                ...
                $output = "
                    <script>
                        ...
                        $(document).ready(function(){
                            ...
                            $('#SAUP190122-btnGuardarFormulario-$id').click(function(){
